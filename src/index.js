...
function requireAuth() {
  if (!isConfigured()) {
    ...
    console.log(chalk.cyan('  nexmo config set --api-key YOUR_API_KEY'));
    process.exit(1);
  }
}
...
program
  .name('nexmo')
  .description(chalk.bold('Nexmo Conversion API CLI') + ' - SMS and communication conversion tracking from your terminal')
  .version('1.0.0');
...
configCmd
  ...
  .action(() => {
    ...
    console.log(chalk.bold('\nNexmo Conversion API CLI Configuration\n'));
